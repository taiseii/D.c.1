...
def epostep(epo_i):
  if (epo_i + 1) < steps_per_epoch[0]:
    return 0.1
  elif (epo_i + 1) < steps_per_epoch[1]:
    return 0.02
  elif (epo_i + 1) < steps_per_epoch[2]:
    return 0.004
  return 0.008
...
"""      
  ...
  if job_dir.startswith("gs://"):
    retinopathy_model.save(RETINOPATHY_MODEL)
    copy_file_to_gcs(job_dir, RETINOPATHY_MODEL)
  else:
